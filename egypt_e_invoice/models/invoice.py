...
class AccountMove(models.Model):
    ...
    def get_invoice_dic(self):
        ...
        invoice_dic = {
            ...
            "extraDiscountAmount": float('%.5f' % self.ks_amount_discount),
        ...
        try:
            ...
            for rejectedDocument in submission.get('rejectedDocuments'):
                ...
                for detail in rejectedDocument.get('error').get('details'):
                    print("44444444444")
                    reject_error += 'Target :' + str(detail.get('target')) + '\n'
                    print("555555555555")
                    reject_error += 'Message :' + str(detail.get('message')) + '\n'
                    print("666666666666")
                    reject_error += 'Path :' + str(detail.get('propertyPath')) + '\n'
                    print("77777777777")
                    reject_error += '=========================================== \n'
