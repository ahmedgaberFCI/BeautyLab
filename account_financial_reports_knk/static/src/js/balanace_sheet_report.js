odoo.define('account_financial_reports_knk.balance_sheet_report', function (require) {
'use strict';
...
var BalanceSheetReport = stock_report_generic.extend({
    events: {
    ...
    get_html: function() {
        ...
        return this._rpc({
                model: 'report.account_financial_reports_knk.report_balance_sheet',
                method: 'get_html',
                args: args,
    ...
    _onClickPrint: function (ev) {
        framework.blockUI();
        var reportname = 'account_financial_reports_knk.report_balance_sheet?docids=' + 1 +
    ...
    _onClickPrint_xls: function(ev) {
            ...
            .then(function (result) {
                session.get_file({
                    url: '/web/balance_sheet_report/export',
...
core.action_registry.add('balance_sheet_report', BalanceSheetReport);
